...
// .wrangler/tmp/pages-zYRqTZ/functionsWorker-0.5138269368564846.mjs
...
var init_utils = __esm({
	"../node_modules/unenv/dist/runtime/_internal/utils.mjs"() {
		init_functionsRoutes_0_38181779459426457();
...
var init_performance = __esm({
	"../node_modules/unenv/dist/runtime/node/internal/perf_hooks/performance.mjs"() {
		...
		PerformanceMark = class PerformanceMark2 extends PerformanceEntry {
			static {
				__name(PerformanceMark2, "PerformanceMark2");
			}
			static {
				__name2(PerformanceMark2, "PerformanceMark");
			}
			entryType = "mark";
			constructor() {
				super(...arguments);
		...
		hrtime = /* @__PURE__ */ Object.assign(
			...
			),
			{
				bigint: /* @__PURE__ */ __name2(
					/* @__PURE__ */ __name(function bigint() {
...
var init_chunk_p7k4hjyd = __esm({
	"chunk-p7k4hjyd.js"() {
		...
		__name2(__accessProp, "__accessProp");
		__toESM = /* @__PURE__ */ __name2((mod, isNodeMode, target) => {
			var canCache = mod != null && typeof mod === "object";
			if (canCache) {
				var cache = isNodeMode
					? (__toESMCache_node ??= /* @__PURE__ */ new WeakMap())
					: (__toESMCache_esm ??= /* @__PURE__ */ new WeakMap());
			...
			const to =
				isNodeMode || !mod || !mod.__esModule
					? __defProp22(target, "default", { value: mod, enumerable: true })
					: target;
			for (const key of __getOwnPropNames2(mod))
		...
		__commonJS = /* @__PURE__ */ __name2(
			(cb, mod) => () => (
				mod || cb((mod = { exports: {} }).exports, mod), mod.exports
			),
			"__commonJS",
		);
		__returnValue = /* @__PURE__ */ __name2((v) => v, "__returnValue");
		__name2(__exportSetter, "__exportSetter");
		...
		require_react_development = __commonJS((exports, module) => {
			(() => {
				...
				function ReactElement(type, key, props, owner, debugStack, debugTask) {
					...
					(refProp !== void 0 ? refProp : null) !== null
				...
				function escape(key) {
					...
					return "$" + key.replace(/[=:]/g, (match2) => escaperLookup[match2]);
				}
				...
				function mapChildren(children, func, context2) {
					...
					mapIntoArray(children, result, "", "", (child) =>
						func.call(context2, child, count3++),
					);
					return result;
				}
...
See https://react.dev/link/invalid-hook-call for tips about how to debug and fix this problem.`);
				...
				function enqueueTask(task) {
					if (enqueueTaskImpl === null)
						try {
							...
							enqueueTaskImpl = /* @__PURE__ */ __name2((callback) => {
				...
				function aggregateErrors(errors) {
					return 1 < errors.length && typeof AggregateError === "function"
				...
				var REACT_ELEMENT_TYPE = /* @__PURE__ */ Symbol.for(
					...
					ReactNoopUpdateQueue = {
						isMounted: /* @__PURE__ */ __name2(() => false, "isMounted"),
						enqueueForceUpdate: /* @__PURE__ */ __name2((publicInstance) => {
							warnNoop(publicInstance, "forceUpdate");
						}, "enqueueForceUpdate"),
						enqueueReplaceState: /* @__PURE__ */ __name2((publicInstance) => {
							warnNoop(publicInstance, "replaceState");
						}, "enqueueReplaceState"),
						enqueueSetState: /* @__PURE__ */ __name2((publicInstance) => {
				...
				var isArrayImpl = Array.isArray,
					...
					createTask3 = console.createTask ? console.createTask : () => null;
				deprecatedAPIs = {
					react_stack_bottom_frame: /* @__PURE__ */ __name2(
				...
				var fnName = {
					...
					count: /* @__PURE__ */ __name2((children) => {
						var n = 0;
					...
					toArray: /* @__PURE__ */ __name2(
						(children) => mapChildren(children, (child) => child) || [],
						"toArray",
					),
					only: /* @__PURE__ */ __name2((children) => {
				...
				exports.act = (callback) => {
					...
					if (
						...
						return {
							then: /* @__PURE__ */ __name2((resolve, reject) => {
				...
				exports.cloneElement = function (element, config2, children) {
					...
					if (config2 != null) {
						...
						a: {
							if (
								hasOwnProperty.call(config2, "ref") &&
						...
						for (propName in config2)
							!hasOwnProperty.call(config2, propName) ||
								...
								propName === "__self" ||
								propName === "__source" ||
								(propName === "ref" && config2.ref === void 0) ||
				...
				exports.forwardRef = (render) => {
					...
					Object.defineProperty(elementType, "displayName", {
						enumerable: false,
						configurable: true,
						get: /* @__PURE__ */ __name2(() => ownName, "get"),
						set: /* @__PURE__ */ __name2((name) => {
							ownName = name;
							render.name ||
								render.displayName ||
				...
				exports.useImperativeHandle = (ref2, create, deps) =>
					resolveDispatcher().useImperativeHandle(ref2, create, deps);
...
var init_chunk_6n755qe6 = __esm({
	"chunk-6n755qe6.js"() {
		...
		__name2(createLoader, "createLoader");
		CtxContext = import_react.createContext(null);
	},
});
var require_react_jsx_dev_runtime_development;
var require_jsx_dev_runtime;
var init_chunk_4crj6n2b = __esm({
	"chunk-4crj6n2b.js"() {
		init_functionsRoutes_0_38181779459426457();
		init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
		init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
			...
			(() => {
				...
				function jsxDEVImpl(
					...
					if (hasOwnProperty.call(config2, "key")) {
						...
						var keys = Object.keys(config2).filter((k) => k !== "key");
						isStaticChildren =
							0 < keys.length
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
				...
				exports.Fragment = REACT_FRAGMENT_TYPE;
				exports.jsxDEV = (type, config2, maybeKey, isStaticChildren) => {
		...
		require_jsx_dev_runtime = __commonJS((exports, module) => {
			var react_jsx_dev_runtime_development = __toESM(
				require_react_jsx_dev_runtime_development(),
			);
			if (false) {
			} else {
...
function useLoader(loader) {
	...
	const props = import_react2.useContext(PropsContext);
	if (typeof window === "undefined") {
		return ctx?.data?.loader?.get(loader);
	}
	console.log(props, loader);
	return props?.find((prop) => prop.name === loader.name)?.data;
}
...
var init_chunk_rabaqkb6 = __esm({
	"chunk-rabaqkb6.js"() {
		...
		PropsContext = import_react3.createContext(null);
		__name2(useLoader, "useLoader");
	},
});
function Dynamic() {
...
var init_id = __esm({
	"dynamic/[id].js"() {
		...
		__export2(exports__id_, {
			loader_idData: /* @__PURE__ */ __name2(
				() => loader_idData,
				"loader_idData",
			),
			default: /* @__PURE__ */ __name2(() => Dynamic, "default"),
		});
...
function TestComponent() {
	const [data, setData] = import_react4.useState(0);
	return /* @__PURE__ */ jsx_dev_runtime3.jsxDEV(
		"button",
		{
			onClick: /* @__PURE__ */ __name2(() => setData((c) => c + 1), "onClick"),
			type: "button",
			children: ["Test button ", data],
		},
		void 0,
		true,
		void 0,
...
__name(TestComponent, "TestComponent");
var import_react4;
var jsx_dev_runtime3;
var init_chunk_faq8bgry = __esm({
	"chunk-faq8bgry.js"() {
		init_functionsRoutes_0_38181779459426457();
		init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
		init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
		...
		__name2(TestComponent, "TestComponent");
	},
});
function Subroute() {
	const data = useLoader(loader_SubRouteServerData);
	return /* @__PURE__ */ jsx_dev_runtime4.jsxDEV(
		"div",
		{
			children: [
				/* @__PURE__ */ jsx_dev_runtime4.jsxDEV(
					"h1",
					{
						children: "Subroute",
					},
...
var init_subroute = __esm({
	"subroute/index.js"() {
		...
		__export2(exports_subroute, {
			loader_SubRouteServerData: /* @__PURE__ */ __name2(
				() => loader_SubRouteServerData,
				"loader_SubRouteServerData",
			),
			default: /* @__PURE__ */ __name2(() => Subroute, "default"),
		});
		jsx_dev_runtime4 = __toESM(require_jsx_dev_runtime(), 1);
		loader_SubRouteServerData = createLoader({
			name: "subRouteServerData",
			callback: /* @__PURE__ */ __name2(async () => {
				return await fetch("https://jsonplaceholder.typicode.com/todos/1").then(
					(res) => res.json(),
				);
			}, "callback"),
		});
		__name2(Subroute, "Subroute");
		onRequest2 = /* @__PURE__ */ __name2(async (ctx) => {
			const acceptedTypes = ctx.request.headers
					.get("accept")
					?.includes("application/vnd.ssr.props+json")
					? "props"
...
function SyncPage() {
	return /* @__PURE__ */ jsx_dev_runtime5.jsxDEV(
		"section",
		{
			children: [
				"This is a sync page ",
...
var init_sync = __esm({
	"sync/index.js"() {
		...
		init_chunk_p7k4hjyd();
		exports_sync = {};
		__export2(exports_sync, {
			default: /* @__PURE__ */ __name2(() => SyncPage, "default"),
		});
		jsx_dev_runtime5 = __toESM(require_jsx_dev_runtime(), 1);
		__name2(SyncPage, "SyncPage");
		onRequest3 = /* @__PURE__ */ __name2(async (ctx) => {
			const acceptedTypes = ctx.request.headers
					.get("accept")
					?.includes("application/vnd.ssr.props+json")
					? "props"
...
var chunk_331bw8en_exports = {};
__export(chunk_331bw8en_exports, {
	default: /* @__PURE__ */ __name(() => chunk_331bw8en_default, "default"),
	renderToReadableStream: /* @__PURE__ */ __name(
		() => $renderToReadableStream,
		"renderToReadableStream",
	),
	renderToStaticMarkup: /* @__PURE__ */ __name(
		() => $renderToStaticMarkup,
		"renderToStaticMarkup",
	),
	renderToString: /* @__PURE__ */ __name(
		() => $renderToString,
		"renderToString",
	),
	resume: /* @__PURE__ */ __name(() => $resume, "resume"),
	version: /* @__PURE__ */ __name(() => $version, "version"),
});
var require_react_dom_development;
var require_react_dom;
var require_react_dom_server_legacy_browser_development;
var require_react_dom_server_browser_development;
var react_dom_server_legacy_browser_development;
var react_dom_server_browser_development;
var l;
var s;
var $version;
var $renderToString;
...
var $resume;
var chunk_331bw8en_default;
var init_chunk_331bw8en = __esm({
	"chunk-331bw8en.js"() {
		init_functionsRoutes_0_38181779459426457();
		init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
		init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
See https://react.dev/link/invalid-hook-call for tips about how to debug and fix this problem.`);
				...
				exports.prefetchDNS = function (href) {
					if (typeof href !== "string" || !href)
						...
						typeof options === "object" && Object.hasOwn(options, "crossOrigin")
							? console.error(
						...
						as === "style"
							...
							: as === "script" &&
								Internals.d.X(href, {
									...
									fetchPriority,
									nonce:
										typeof options.nonce === "string" ? options.nonce : void 0,
								});
					}
				};
				exports.preinitModule = (href, options) => {
					...
					if (encountered)
						...
						switch (
							((encountered =
								options && typeof options.as === "string"
									? options.as
									: "script"),
							encountered)
						) {
				...
				exports.preload = (href, options) => {
					...
					options == null || typeof options !== "object"
						? (encountered +=
								...
								getValueDescriptorExpectingObjectForWarning(options) +
								".")
						: (typeof options.as === "string" && options.as) ||
							(encountered +=
								" The `as` option encountered was " +
		...
		require_react_dom_server_legacy_browser_development = __commonJS(
			(exports) => {
				var React = __toESM(require_react());
							...
							if (jsxPropsParents.has(objectOrArray)) {
								...
								for (i = 0; i < type.length; i++)
									0 < i && (objKind += ", "),
										...
										(_value2 =
											typeof _value2 === "object" && _value2 !== null
												? describeObjectForErrorMessage(_value2)
												: describeValueForErrorMessage(_value2)),
										value === expandedName
											? ((start = objKind.length),
  ...
  ` + objKind;
					...
					function murmurhash3_32_gc(key, seed) {
						...
						for (seed = 0; seed < bytes; ) {
							...
							h1 =
								...
								4294967295;
							h1 =
								(h1 & 65535) + 27492 + ((((h1 >>> 16) + 58964) & 65535) << 16);
						}
						k1 = 0;
						switch (remainder) {
							case 3:
					...
					function validateProperty(tagName, name, value, eventRegistry) {
						...
						if (
							...
							((tagName === "form" && name === "action") ||
								(tagName === "input" && name === "formAction") ||
								(tagName === "button" && name === "formAction"))
						)
							return true;
						if (eventRegistry != null) {
							tagName = eventRegistry.possibleRegistrationNames;
							if (
								Object.hasOwn(eventRegistry.registrationNameDependencies, name)
							)
								return true;
					...
					__name(
						escapeEntireInlineScriptContent,
						"escapeEntireInlineScriptContent",
					);
					__name2(
						escapeEntireInlineScriptContent,
					...
					function getSuspenseViewTransition(parentViewTransition) {
						return parentViewTransition === null
							? null
							: {
									...
									if (styleName.indexOf("--") === 0) {
										...
										if (-1 < nameChunk.indexOf("-")) {
											...
											(Object.hasOwn(warnedStyleValues, value$jscomp$0) &&
												...
												((warnedStyleValues[value$jscomp$0] = true),
												console.error(
										...
										typeof styleValue === "number"
											? (styleValue =
													styleValue === 0 || unitlessNumbers.has(styleName)
														? "" + styleValue
														: styleValue + "px")
											: (checkCSSPropertyStringCoercion(styleValue, styleName),
									...
									if (
										...
										switch (typeof value) {
											...
											case "boolean": {
												...
												if (prefix2 !== "data-" && prefix2 !== "aria-") return;
											}
										}
										target.push(
											attributeSeparator,
...
` &&
									...
									var children$jscomp$6 = props.children,
										child = Array.isArray(children$jscomp$6)
											? 2 > children$jscomp$6.length
												...
												: null
											: children$jscomp$6;
									Array.isArray(children$jscomp$6) &&
									1 < children$jscomp$6.length
										? console.error(
										...
										: typeof child === "function" || typeof child === "symbol"
											? console.error(
								...
								if (
									...
									if (resourceState$jscomp$0 !== EXISTS) {
										...
										if (resourceState$jscomp$0) {
											resourceState$jscomp$0.length === 2 &&
							...
							case "style": {
									...
									var children$jscomp$7 = props.children,
										child$jscomp$0 = Array.isArray(children$jscomp$7)
											? 2 > children$jscomp$7.length
												...
												: null
											: children$jscomp$7;
									(typeof child$jscomp$0 === "function" ||
										typeof child$jscomp$0 === "symbol" ||
								...
								if (
									...
									props.itemProp != null ||
									typeof precedence$jscomp$0 !== "string" ||
									...
									var child$jscomp$1 = Array.isArray(children$jscomp$8)
										? 2 > children$jscomp$8.length
											...
											: null
										: children$jscomp$8;
									typeof child$jscomp$1 !== "function" &&
										typeof child$jscomp$1 !== "symbol" &&
										child$jscomp$1 !== null &&
										child$jscomp$1 !== void 0 &&
										target$jscomp$0.push(
											escapeStyleTextContent(child$jscomp$1),
										);
									pushInnerHTML(
										target$jscomp$0,
										innerHTML$jscomp$5,
										...
										if (nonceStyle && nonceStyle !== nonce)
											...
											var child$jscomp$2 = Array.isArray(children$jscomp$9)
												? 2 > children$jscomp$9.length
													...
													: null
												: children$jscomp$9;
											typeof child$jscomp$2 !== "function" &&
												typeof child$jscomp$2 !== "symbol" &&
												child$jscomp$2 !== null &&
												child$jscomp$2 !== void 0 &&
							...
							case "pre": {
								...
								if (innerHTML$jscomp$7 != null) {
									...
									if (
										typeof innerHTML$jscomp$7 !== "object" ||
...
`
								...
								typeof children$jscomp$10 === "string" &&
...
` &&
							...
							case "img": {
								...
								if (
									...
									var sizes =
											typeof props.sizes === "string" ? props.sizes : void 0,
										key$jscomp$0 = srcSet
											? srcSet +
												`
` +
												...
												switch (propKey$jscomp$11) {
													...
													default:
														if (
															...
															typeof propValue$jscomp$11 !== "function" &&
															typeof propValue$jscomp$11 !== "symbol" &&
															propValue$jscomp$11 !== false
														) {
					...
					function hoistPreambleState(renderState, preambleState) {
						...
						renderState.headChunks === null &&
							preambleState.headChunks &&
							(renderState.headChunks = preambleState.headChunks);
						renderState.bodyChunks === null &&
								...
								if (resource.state === LATE)
									...
									for (var propKey in props)
										if (
											...
											((precedence = props[propKey]), precedence != null)
										)
											switch (propKey) {
												case "href":
												case "rel":
					...
					__name(
						writeStyleResourceDependenciesInJS,
						"writeStyleResourceDependenciesInJS",
					);
					__name2(
						writeStyleResourceDependenciesInJS,
					...
					__name(
						escapeHrefForLinkHeaderURLContext,
						"escapeHrefForLinkHeaderURLContext",
					);
					__name2(
						escapeHrefForLinkHeaderURLContext,
						...
						if (bootstrapModules !== void 0)
							for (
								...
								(bootstrapScriptContent = bootstrapModules[bootstrapScripts]),
									...
									typeof bootstrapScriptContent === "string"
										...
										: ((integrity.href = scriptConfig =
											...
											(integrity.integrity = crossOrigin =
												typeof bootstrapScriptContent.integrity === "string"
													? bootstrapScriptContent.integrity
													: void 0),
											(integrity.crossOrigin = src =
												typeof bootstrapScriptContent === "string" ||
												bootstrapScriptContent.crossOrigin == null
													? void 0
...
Incoming: %s`,
					...
					function useActionState(action, initialState, permalink) {
						...
						if (typeof action.$$FORM_ACTION === "function") {
							...
							action = /* @__PURE__ */ __name2((payload) => {
								boundAction(payload);
							}, "action");
							typeof boundAction.$$FORM_ACTION === "function" &&
								(action.$$FORM_ACTION = (prefix2) => {
									prefix2 = boundAction.$$FORM_ACTION(prefix2);
									permalink !== void 0 &&
										(checkAttributeStringCoercion(permalink, "target"),
										(permalink += ""),
										(prefix2.action = permalink));
									var formData = prefix2.data;
									formData &&
										(nextPostbackStateKey === null &&
											(nextPostbackStateKey =
												permalink !== void 0
													? "p" + permalink
													: "k" +
...
`);
						prevPrepareStackTrace !== -1 &&
							(error3 = error3.slice(prevPrepareStackTrace + 1));
						prevPrepareStackTrace = error3.indexOf("react_stack_bottom_frame");
						prevPrepareStackTrace !== -1 &&
							(prevPrepareStackTrace = error3.lastIndexOf(
								`
`,
...
` +
					...
					function describeNativeComponentFrame(fn, construct) {
						...
						try {
							var RunInRootFrame = {
								DetermineComponentFrameRoot: /* @__PURE__ */ __name2(() => {
									try {
										if (construct) {
											var Fake = /* @__PURE__ */ __name2(() => {
												throw Error();
											}, "Fake");
...
`);
								...
								for (
									...
									if (
										...
										if (
											namePropDescriptor !== 1 ||
											_RunInRootFrame$Deter !== 1
										) {
											do
												if (
													(namePropDescriptor--,
...
` + type;
					...
					function defaultErrorHandler(error3) {
						if (
							typeof error3 === "object" &&
							error3 !== null &&
							typeof error3.environmentName === "string"
						) {
					...
					function RequestInstance(
						...
						this.progressiveChunkSize =
							progressiveChunkSize === void 0 ? 12800 : progressiveChunkSize;
						this.status = 10;
						this.fatalError = null;
						this.pendingRootTasks =
						...
						try {
							...
							if (typeof componentStack.type === "string")
								...
								if (!componentStack.owner) {
									var JSCompiler_temp_const = info3,
								...
								componentStack.owner ||
									(info3 += describeComponentStackByType(componentStack.type));
							for (; componentStack; )
								(JSCompiler_temp_const = null),
									componentStack.debugStack != null
										? (JSCompiler_temp_const = formatOwnerStack(
												componentStack.debugStack,
											))
										: ((JSCompiler_inline_result = componentStack),
											JSCompiler_inline_result.stack != null &&
												(JSCompiler_temp_const =
													typeof JSCompiler_inline_result.stack !== "string"
					...
					function pushHaltedAwaitOnComponentStack(task, debugInfo) {
						if (debugInfo != null)
							for (var i = debugInfo.length - 1; 0 <= i; i--) {
								...
								if (typeof info3.name === "string") break;
								if (typeof info3.time === "number") break;
								if (info3.awaited != null) {
									var bestStack =
										info3.debugStack == null ? info3.awaited : info3;
						...
						if (debugInfo != null)
							for (var i = 0; i < debugInfo.length; i++) {
								...
								typeof componentInfo.name === "string" &&
									componentInfo.debugStack !== void 0 &&
									((task.componentStack = {
										parent: task.componentStack,
										type: componentInfo,
								...
								get: /* @__PURE__ */ __name2(() => {
									try {
										var info3 = "",
											node = node$jscomp$0;
										do
											(info3 += describeComponentStackByType(node.type)),
												(node = node.parent);
										while (node);
										var stack = info3;
									} catch (x) {
...
` +
					...
					function encodeErrorForBoundary(
						...
						error3 instanceof Error
							? ((digest = String(error3.message)),
								(error3 = String(error3.stack)))
							: ((digest =
									typeof error3 === "object" && error3 !== null
										? describeObjectForErrorMessage(error3)
										: String(error3)),
								(error3 = null));
...
`;
					...
					function logRecoverableError(request, error3, errorInfo, debugTask) {
						...
						error3 = debugTask
							? debugTask.run(request.bind(null, error3, errorInfo))
							: request(error3, errorInfo);
					...
					function fatalError(request, error3, errorInfo, debugTask) {
						...
						debugTask
							? (debugTask.run(errorInfo.bind(null, error3)),
								debugTask.run(onFatalError.bind(null, error3)))
							: (errorInfo(error3), onFatalError(error3));
						request.destination !== null
							? ((request.status = CLOSED), request.destination.destroy(error3))
							: ((request.status = 13), (request.fatalError = error3));
					}
					...
					function tryToResolveTogetherRow(request, togetherRow) {
						...
						if (
							...
							for (
								var allCompleteAndInlinable = true, i = 0;
								i < boundaries.length;
								i++
							) {
					...
					function renderSuspenseListRows(
						...
						var {
							keyPath: prevKeyPath,
							treeContext: prevTreeContext,
							row: prevRow,
							componentStack: previousComponentStack,
						} = task;
						...
						if (task.replay !== null) {
							...
							for (i = keyPath - 1; 0 <= i; i--) {
								...
								resumeSegmentID = createPendingSegment(
									...
									null,
									task.formatContext,
									i === 0 ? revealOrder.lastPushedText : true,
									true,
								);
								...
								try {
									...
									throw (
										((resumeSegmentID.status =
											request.status === 12 ? ABORTED : ERRORED),
										thrownValue)
									);
								}
							}
					...
					function renderElement(request, task, keyPath, type, props, ref2) {
						if (typeof type === "function")
							if (type.prototype && type.prototype.isReactComponent) {
								...
								typeof contextType === "object" &&
									contextType !== null &&
									(context2 = contextType._currentValue2);
...
https://react.dev/link/unsafe-component-lifecycles`,
  ...
  ` + foundWillUpdateName
								...
								state &&
									(typeof state !== "object" || isArrayImpl(state)) &&
									console.error(
								...
								instance.context =
									typeof contextType$jscomp$0 === "object" &&
									contextType$jscomp$0 !== null
...
Please update the following components: %s`,
									...
									if (
										...
										var { queue: oldQueue, replace: oldReplace } =
											internalInstance;
										internalInstance.queue = null;
								...
								if (type.contextTypes) {
									...
									didWarnAboutContextTypes[_componentName$jscomp$0] ||
										((didWarnAboutContextTypes[_componentName$jscomp$0] = true),
										console.error(
  ...
  %s.childContextTypes = ...`,
								...
								if (
									typeof type.contextType === "object" &&
							...
							if (segment === null) {
								...
								var { formatContext: _prevContext2, keyPath: _prevKeyPath3 } =
									task;
								task.keyPath = keyPath;
								if (
									(task.formatContext = getChildFormatContext(
							...
							switch (type) {
								...
								case REACT_SUSPENSE_LIST_TYPE:
									a: {
										...
										if (revealOrder === "together") {
											var { keyPath: _prevKeyPath2, row: prevRow } = task,
								...
								case REACT_SUSPENSE_TYPE:
									a: if (task.replay !== null) {
										var {
											keyPath: _prevKeyPath,
											formatContext: _prevContext,
											row: _prevRow,
										} = task;
										task.keyPath = keyPath;
										...
										var {
												keyPath: prevKeyPath$jscomp$4,
												formatContext: prevContext$jscomp$0,
												row: prevRow$jscomp$0,
												blockedBoundary: parentBoundary,
												blockedPreamble: parentPreamble,
												hoistableState: parentHoistableState,
												blockedSegment: parentSegment,
											} = task,
											...
											try {
												if (
													...
													if (
														...
														prevRow$jscomp$0 !== null &&
															--prevRow$jscomp$0.pendingTasks === 0 &&
							...
							if (typeof type === "object" && type !== null)
								switch (type.$$typeof) {
									...
									case REACT_MEMO_TYPE:
										...
										return;
									case REACT_CONTEXT_TYPE: {
										var { value: value$jscomp$0, children: children$jscomp$2 } =
											props;
										var prevSnapshot = task.context;
										var prevKeyPath$jscomp$5 = task.keyPath;
										var prevValue = type._currentValue2;
										type._currentValue2 = value$jscomp$0;
										type._currentRenderer2 !== void 0 &&
											type._currentRenderer2 !== null &&
							...
							throw Error(
								"Element type is invalid: expected a string (for built-in components) or a class/function (for composite components) but got: " +
									((type == null ? type : typeof type) + "." + info3),
							);
						}
					}
					...
					function resumeNode(request, task, segmentId, node, childIndex) {
						var { replay: prevReplay, blockedBoundary } = task,
							...
							if (keyOrIndex === node[1]) {
								if (node.length === 4) {
									...
									a: {
										...
										var {
												keyPath: prevKeyPath,
												formatContext: prevContext,
												row: prevRow,
												replay: previousReplaySet,
												blockedBoundary: parentBoundary,
												hoistableState: parentHoistableState,
											} = task,
											content = props.children,
					...
					function renderNodeDestructive(request, task, node, childIndex) {
						task.replay !== null && typeof task.replay.slots === "number"
  ...
  %s`,
					...
					function warnForMissingKey(request, task, child) {
						if (
							...
							didWarnForKey == null &&
								(didWarnForKey = request.didWarnForKey =
...
Check the top-level render call using <` +
								...
								didWarnForKey != null &&
									...
									((parentOwner = null),
									typeof didWarnForKey.type !== "undefined"
										? (parentOwner = getComponentNameFromType(
												didWarnForKey.type,
											))
										: typeof didWarnForKey.name === "string" &&
					...
					function renderChildrenArray(request, task, children, childIndex) {
						...
						if (
							task.replay !== null &&
							((j = task.replay.slots), j !== null && typeof j === "object")
						) {
							for (childIndex = 0; childIndex < replayNodes; childIndex++)
								(node = children[childIndex]),
									...
									(error3 = j[childIndex]),
									typeof error3 === "number"
										? (resumeNode(request, task, error3, node, childIndex),
											delete j[childIndex])
										: renderNode(request, task, node, childIndex);
					...
					function trackPostpone(request, trackedPostpones, task, segment) {
						...
						if (boundary === null)
							...
							segment.id === -1 &&
								(segment.id =
									segment.parentFlushed && boundary !== null
										? boundary.rootSegmentID
										: request.nextSegmentId++);
							if (task.childIndex === -1)
								...
								if (keyPath === null)
									if (
										((request = trackedPostpones.rootSlots), request === null)
									)
					...
					function renderNode(request, task, node, childIndex) {
						var {
							formatContext: previousFormatContext,
							context: previousContext,
							keyPath: previousKeyPath,
							treeContext: previousTreeContext,
							componentStack: previousComponentStack,
							debugTask: previousDebugTask,
									...
									if (node.message === "Maximum call stack size exceeded") {
										segment =
											thrownValue$3 === SuspenseException
												? getThenableStateAfterSuspending()
												: null;
										segment = spawnNewSuspendedRenderTask(
											request,
											task,
											segment,
										);
								...
								if (boundary === null) {
									request.trackedPostpones !== null && segment !== null
										...
										: (logRecoverableError(
											...
											fatalError(request, error3, errorInfo, task.debugTask));
									return;
								}
								boundary.pendingTasks--;
								boundary.pendingTasks === 0 &&
								...
								if (node !== null && segment !== null)
									return (
										...
										boundary.fallbackAbortableTasks.forEach((fallbackTask) =>
											abortTask(fallbackTask, request, error3),
										),
						...
						if (boundary === null) {
							...
							if (boundary.pendingTasks === 0)
								if (
									...
									if (
										boundary.status === POSTPONED &&
										((boundary = boundary.row), boundary !== null)
									) {
										if (request.trackedPostpones !== null) {
											...
											if (
												postponedRow !== null &&
												((segment = postponedRow.boundaries), segment !== null)
											)
												for (
								...
								segment === null ||
									...
									(segment.status !== COMPLETED &&
										segment.status !== ABORTED) ||
									(queueCompletedSegment(boundary, segment),
									boundary.completedSegments.length === 1 &&
										boundary.parentFlushed &&
					...
					function performWork(request$jscomp$2) {
						if (
							...
							try {
								...
								for (i = 0; i < pingedTasks.length; i++) {
									...
									if (segment === null) {
										...
										if (request.replay.pendingTasks !== 0) {
											...
											try {
												typeof request.replay.slots === "number"
													? resumeNode(
															request$jscomp$0,
															request,
												...
												if (
													...
													request$jscomp$0.pendingRootTasks === 0 &&
														completeShell(request$jscomp$0);
													request$jscomp$0.allPendingTasks--;
													request$jscomp$0.allPendingTasks === 0 &&
										...
										try {
											...
											if (
												...
												typeof x$jscomp$0 === "object" &&
												x$jscomp$0 !== null &&
												typeof x$jscomp$0.then === "function"
											) {
												request$jscomp$1.status = PENDING;
												...
												var {
													blockedBoundary: boundary$jscomp$0,
													row,
													debugTask,
												} = errorDigest;
												row !== null &&
												...
												if (boundary$jscomp$0 === null)
													...
													request.pendingRootTasks === 0 &&
														request.trackedPostpones === null &&
														boundary$jscomp$0.contentPreamble !== null &&
														preparePreamble(request);
												}
												request.allPendingTasks === 0 && completeAll(request);
											}
								...
								request$jscomp$2.destination !== null &&
								...
								(pingedTasks = {}),
									...
									fatalError(request$jscomp$2, error3, pingedTasks, null);
							} finally {
					...
					function preparePreambleFromSubtree(
						...
						for (
							var pendingPreambles = false, i = 0;
					...
					function preparePreambleFromSegment(
						...
						switch (boundary.status) {
							...
							case POSTPONED:
								if (request.trackedPostpones !== null) return true;
					...
					function flushCompletedBoundary(request, destination, boundary) {
						...
						completedSegments !== null &&
							isEligibleForOutlining(request, boundary) &&
							--completedSegments.pendingTasks === 0 &&
						...
						try {
							if (!(0 < request.pendingRootTasks)) {
								...
								if (completedRootSegment !== null) {
									...
									currentlyFlushingRenderState = renderState;
									renderState.styles.forEach(
										flushStylesInPreamble,
										destination,
									);
									currentlyFlushingRenderState = null;
								...
								var viewportChunks$jscomp$0 =
									renderState$jscomp$1.viewportChunks;
								for (
									completedRootSegment = 0;
								...
								renderState$jscomp$1.scripts.forEach(
									flushResource,
									destination,
								);
								...
								for (i = 0; i < clientRenderedBoundaries.length; i++) {
									...
									var {
											resumableState: resumableState$jscomp$1,
											renderState: renderState$jscomp$2,
										} = request,
								...
								for (i = 0; i < partialBoundaries.length; i++) {
									a: {
										...
										row !== null &&
											row.together &&
											boundary$jscomp$0.pendingTasks === 1 &&
											(row.pendingTasks === 1
												? unblockSuspenseListRow(
														clientRenderedBoundaries,
														row,
					...
					function startWork(request) {
						...
						request.trackedPostpones === null &&
							safelyEmitEarlyPreloads(request, request.pendingRootTasks === 0);
					}
					...
					function startFlowing(request, destination) {
						if (request.status === 13)
							...
							try {
								...
								(destination = {}),
									logRecoverableError(request, error3, destination, null),
									fatalError(request, error3, destination, null);
							}
						}
					}
					...
					__name(abort2, "abort2");
					__name2(abort2, "abort");
					function addToReplayParent(node, parentKeyPath, trackedPostpones) {
						if (parentKeyPath === null) trackedPostpones.rootNodes.push(node);
						else {
					...
					function renderToStringImpl(
						...
						startFlowing(children, {
							push: /* @__PURE__ */ __name2((chunk) => {
								chunk !== null && (result += chunk);
								return true;
							}, "push"),
							destroy: /* @__PURE__ */ __name2((error3) => {
								didFatal = true;
								fatalError2 = error3;
							}, "destroy"),
						});
					...
					var REACT_ELEMENT_TYPE = /* @__PURE__ */ Symbol.for(
						...
						REACT_ACTIVITY_TYPE = /* @__PURE__ */ Symbol.for("react.activity"),
						REACT_LEGACY_HIDDEN_TYPE = /* @__PURE__ */ Symbol.for(
							"react.legacy_hidden",
						),
						REACT_MEMO_CACHE_SENTINEL = /* @__PURE__ */ Symbol.for(
						...
						MAYBE_ITERATOR_SYMBOL = Symbol.iterator,
						isArrayImpl = Array.isArray,
						jsxPropsParents = /* @__PURE__ */ new WeakMap(),
						jsxChildrenParents = /* @__PURE__ */ new WeakMap(),
						CLIENT_REFERENCE_TAG = /* @__PURE__ */ Symbol.for(
							"react.client.reference",
						),
						assign = Object.assign,
						hasOwnProperty = Object.prototype.hasOwnProperty,
					...
					ReactDOMSharedInternals.d = {
						...
						C: /* @__PURE__ */ __name2((href, crossOrigin) => {
							var request = currentRequest ? currentRequest : null;
							if (request) {
								var { resumableState, renderState } = request;
								if (typeof href === "string" && href) {
									...
									if (
										!Object.hasOwn(
											resumableState.connectResources[bucket],
											href,
										)
									) {
						...
						L: /* @__PURE__ */ __name2((href, as, options) => {
							var request = currentRequest ? currentRequest : null;
							if (request) {
								var { resumableState, renderState } = request;
								if (as && href) {
...
` +
										...
										default:
											...
											if (
												...
												0 <=
													(resumableState.remainingCapacity -= key.length + 2))
											)
						...
						m: /* @__PURE__ */ __name2((href, options) => {
							var request = currentRequest ? currentRequest : null;
							if (request) {
								var { resumableState, renderState } = request;
								if (href) {
									...
									switch (as) {
										...
										default:
											if (
												...
												(resources = {}),
													(resumableState.moduleUnknownResources[as] =
														resources);
											as = [];
						...
						X: /* @__PURE__ */ __name2((src, options) => {
							var request = currentRequest ? currentRequest : null;
							if (request) {
								var { resumableState, renderState } = request;
								if (src) {
						...
						S: /* @__PURE__ */ __name2((href, precedence, options) => {
							var request = currentRequest ? currentRequest : null;
							if (request) {
								var { resumableState, renderState } = request;
								if (href) {
						...
						M: /* @__PURE__ */ __name2((src, options) => {
							var request = currentRequest ? currentRequest : null;
							if (request) {
								var { resumableState, renderState } = request;
								if (src) {
					...
					var ROOT_HTML_MODE = 0,
						...
						styleNameCache = /* @__PURE__ */ new Map(),
						...
						didWarnDefaultInputValue = false,
						didWarnDefaultChecked = false,
						didWarnDefaultSelectValue = false,
						didWarnDefaultTextareaValue = false,
						didWarnInvalidOptionChildren = false,
						didWarnInvalidOptionInnerHTML = false,
						...
						formReplayingRuntimeScript = `addEventListener("submit",function(a){if(!a.defaultPrevented){var c=a.target,d=a.submitter,e=c.action,b=d;if(d){var f=d.getAttribute("formAction");null!=f&&(e=f,b=null)}"javascript:throw new Error('React form unexpectedly submitted.')"===e&&(a.preventDefault(),b?(a=document.createElement("input"),a.name=b.name,a.value=b.value,b.parentNode.insertBefore(a,b),b=new FormData(c),a.parentNode.removeChild(a)):b=new FormData(c),a=c.ownerDocument||c,(a.$$reactFormReplay=a.$$reactFormReplay||[]).push(c,d,b))}});`,
						styleRegex = /(<\/|<)(s)(tyle)/gi,
						leadingNewline = `
`,
						VALID_TAG_REGEX = /^[a-zA-Z][a-zA-Z:_.\-\d]*$/,
						validatedTagCache = /* @__PURE__ */ new Map(),
						endTagCache = /* @__PURE__ */ new Map(),
						...
						completeSegmentScriptEnd = '")</script>',
						completeBoundaryScriptFunctionOnly = `$RB=[];$RV=function(a){$RT=performance.now();for(var b=0;b<a.length;b+=2){var c=a[b],e=a[b+1];null!==e.parentNode&&e.parentNode.removeChild(e);var f=c.parentNode;if(f){var g=c.previousSibling,h=0;do{if(c&&8===c.nodeType){var d=c.data;if("/$"===d||"/&"===d)if(0===h)break;else h--;else"$"!==d&&"$?"!==d&&"$~"!==d&&"$!"!==d&&"&"!==d||h++}d=c.nextSibling;f.removeChild(c);c=d}while(c);for(;e.firstChild;)f.insertBefore(e.firstChild,c);g.data="$";g._reactRetry&&requestAnimationFrame(g._reactRetry)}}a.length=0};
$RC=function(a,b){if(b=document.getElementById(b))(a=document.getElementById(a))?(a.previousSibling.data="$~",$RB.push(a,b),2===$RB.length&&("number"!==typeof $RT?requestAnimationFrame($RV.bind(null,$RB)):(a=performance.now(),setTimeout($RV.bind(null,$RB),2300>a&&2E3<a?2300-a:$RT+300-a)))):b.parentNode.removeChild(b)};`,
						completeBoundaryScript1Partial = '$RC("',
						completeBoundaryWithStylesScript1FullPartial = `$RM=new Map;$RR=function(n,w,p){function u(q){this._p=null;q()}for(var r=new Map,t=document,h,b,e=t.querySelectorAll("link[data-precedence],style[data-precedence]"),v=[],k=0;b=e[k++];)"not all"===b.getAttribute("media")?v.push(b):("LINK"===b.tagName&&$RM.set(b.getAttribute("href"),b),r.set(b.dataset.precedence,h=b));e=0;b=[];var l,a;for(k=!0;;){if(k){var f=p[e++];if(!f){k=!1;e=0;continue}var c=!1,m=0;var d=f[m++];if(a=$RM.get(d)){var g=a._p;c=!0}else{a=t.createElement("link");a.href=d;a.rel=
...
"$~";Promise.all(b).then($RC.bind(null,n,w),$RX.bind(null,n,"CSS failed to load"))};$RR("`,
						...
						completeBoundaryScriptEnd = ")</script>",
					...
					var classComponentUpdater = {
							enqueueSetState: /* @__PURE__ */ __name2(
							...
							enqueueReplaceState: /* @__PURE__ */ __name2(
								(inst, payload, callback) => {
							...
							enqueueForceUpdate: /* @__PURE__ */ __name2((inst, callback) => {
								inst._reactInternals.queue === null
						...
						HooksDispatcher = {
							...
							useContext: /* @__PURE__ */ __name2((context2) => {
							...
							useMemo,
							useReducer,
							useRef: /* @__PURE__ */ __name2((initialValue) => {
								currentlyRenderingComponent =
									resolveCurrentlyRenderingComponent();
								workInProgressHook = createWorkInProgressHook();
							...
							useState: /* @__PURE__ */ __name2((initialState) => {
								currentHookNameInDev = "useState";
								return useReducer(basicStateReducer, initialState);
							}, "useState"),
							useInsertionEffect: noop,
							useLayoutEffect: noop,
							useCallback: /* @__PURE__ */ __name2(
							...
							useEffect: noop,
							useDebugValue: noop,
							useDeferredValue: /* @__PURE__ */ __name2(
								(value, initialValue) => {
									resolveCurrentlyRenderingComponent();
							...
							useTransition: /* @__PURE__ */ __name2(() => {
								resolveCurrentlyRenderingComponent();
								return [false, unsupportedStartTransition];
							}, "useTransition"),
							useId: /* @__PURE__ */ __name2(() => {
								var treeId = currentlyRenderingTask.treeContext;
								var overflow = treeId.overflow;
								treeId = treeId.id;
								treeId =
									(treeId & ~(1 << (32 - clz32(treeId) - 1))).toString(32) +
									overflow;
							...
							useSyncExternalStore: /* @__PURE__ */ __name2(
							...
							useOptimistic: /* @__PURE__ */ __name2((passthrough) => {
								resolveCurrentlyRenderingComponent();
								return [passthrough, unsupportedSetOptimisticState];
							}, "useOptimistic"),
							useActionState,
							useFormState: useActionState,
							useHostTransitionStatus: /* @__PURE__ */ __name2(() => {
								resolveCurrentlyRenderingComponent();
								return NotPending;
							}, "useHostTransitionStatus"),
							useMemoCache: /* @__PURE__ */ __name2((size) => {
								for (var data = Array(size), i = 0; i < size; i++)
									data[i] = REACT_MEMO_CACHE_SENTINEL;
								return data;
							}, "useMemoCache"),
							useCacheRefresh: /* @__PURE__ */ __name2(
								() => unsupportedRefresh,
								"useCacheRefresh",
							),
							useEffectEvent: /* @__PURE__ */ __name2(
								() => throwOnUseEffectEventCall,
								"useEffectEvent",
							),
						},
						...
						DefaultAsyncDispatcher = {
							getCacheForType: /* @__PURE__ */ __name2(() => {
								throw Error("Not implemented.");
							}, "getCacheForType"),
							cacheSignal: /* @__PURE__ */ __name2(() => {
								throw Error("Not implemented.");
							}, "cacheSignal"),
							getOwner: /* @__PURE__ */ __name2(
								() =>
									currentTaskInDEV === null
										? null
					...
					var callComponent = {
							react_stack_bottom_frame: /* @__PURE__ */ __name2(
								(Component, props, secondArg) => Component(props, secondArg),
								"react_stack_bottom_frame",
							),
						},
						callComponentInDEV =
						...
						callLazyInit = {
							react_stack_bottom_frame: /* @__PURE__ */ __name2((lazy) => {
								var init = lazy._init;
					...
					if (
						...
						var getCurrentTime = /* @__PURE__ */ __name2(
							() => localPerformance.now(),
							"getCurrentTime",
						);
					} else {
						var localDate = Date;
						getCurrentTime = /* @__PURE__ */ __name2(
							() => localDate.now(),
							"getCurrentTime",
						);
					}
  ...
  ` + objKind;
				...
				function closeWithError(destination, error3) {
					typeof destination.error === "function"
				...
				function createRenderState(
					...
					externalRuntimeConfig =
						typeof nonce === "string" ? nonce : nonce && nonce.script;
					var inlineScriptWithNonce =
							externalRuntimeConfig === void 0
								? startInlineScript
						...
						nonceStyle =
							typeof nonce === "string" ? void 0 : nonce && nonce.style,
					...
					if (bootstrapScripts !== void 0)
						for (
							...
							(maxHeadersLength = bootstrapScripts[importMap]),
								...
								typeof maxHeadersLength === "string"
									...
									: ((idPrefix.href = inlineScriptWithNonce =
										...
										(idPrefix.integrity = inlineStyleWithNonce =
											typeof maxHeadersLength.integrity === "string"
												? maxHeadersLength.integrity
												: void 0),
										(idPrefix.crossOrigin = nonceStyle =
											typeof maxHeadersLength === "string" ||
											maxHeadersLength.crossOrigin == null
												? void 0
												: maxHeadersLength.crossOrigin === "use-credentials"
													? "use-credentials"
													: "")),
								preloadBootstrapScriptOrModule(
									resumableState,
								...
								typeof inlineStyleWithNonce === "string" &&
									bootstrapChunks.push(
										scriptIntegirty,
										stringToChunk(escapeTextForBrowser(inlineStyleWithNonce)),
										attributeEnd,
									),
								typeof nonceStyle === "string" &&
									bootstrapChunks.push(
										scriptCrossOrigin,
					...
					if (bootstrapModules !== void 0)
						for (nonce = 0; nonce < bootstrapModules.length; nonce++)
							(bootstrapScripts = bootstrapModules[nonce]),
								...
								typeof bootstrapScripts === "string"
									...
									: ((nonceStyle.href = importMap = bootstrapScripts.src),
										(nonceStyle.integrity = inlineScriptWithNonce =
											typeof bootstrapScripts.integrity === "string"
												? bootstrapScripts.integrity
												: void 0),
										(nonceStyle.crossOrigin = maxHeadersLength =
											typeof bootstrapScripts === "string" ||
											bootstrapScripts.crossOrigin == null
												? void 0
												: bootstrapScripts.crossOrigin === "use-credentials"
													? "use-credentials"
													: "")),
								preloadBootstrapScriptOrModule(
									resumableState,
								...
								typeof inlineScriptWithNonce === "string" &&
									bootstrapChunks.push(
										scriptIntegirty,
										stringToChunk(escapeTextForBrowser(inlineScriptWithNonce)),
										attributeEnd,
					...
					for (styleName in style)
						if (hasOwnProperty.call(style, styleName)) {
							...
							if (
								...
								if (styleName.indexOf("--") === 0) {
									var nameChunk = stringToChunk(
										escapeTextForBrowser(styleName),
									);
									checkCSSPropertyStringCoercion(styleValue, styleName);
...
%s`,
				...
				function pushScriptImpl(target, props) {
					...
					typeof children === "string" &&
						target.push(
							stringToChunk(escapeEntireInlineScriptContent(children)),
						);
					target.push(endChunkForTag("script"));
					return null;
				}
				...
				function pushStartInstance(
					...
					b: if (type.indexOf("-") === -1) var JSCompiler_inline_result = false;
					else
						switch (type) {
							case "annotation-xml":
							case "color-profile":
...
` +
						...
						case "head":
							if (formatContext.insertionMode < HTML_MODE) {
								...
								preamble.headChunks = [];
								var JSCompiler_inline_result$jscomp$9 =
									pushStartSingletonElement(preamble.headChunks, props, "head");
							} else
								JSCompiler_inline_result$jscomp$9 = pushStartGenericElement(
									target$jscomp$0,
									props,
...
` + type;
				...
				function pingTask(request, task) {
					...
					request.pingedTasks.length === 1 &&
						((request.flushScheduled = request.destination !== null),
						request.trackedPostpones !== null || request.status === 10
				...
				function renderElement(request, task, keyPath, type, props, ref2) {
					if (typeof type === "function")
						if (type.prototype && type.prototype.isReactComponent) {
							...
							typeof contextType === "object" &&
								contextType !== null &&
								(context2 = contextType._currentValue);
							var instance = new type(resolvedProps, context2);
							if (
								typeof type.getDerivedStateFromProps === "function" &&
								(instance.state === null || instance.state === void 0)
						...
						if (typeof type === "object" && type !== null)
							switch (type.$$typeof) {
								...
								case REACT_CONTEXT_TYPE: {
									...
									type._currentRenderer !== void 0 &&
										type._currentRenderer !== null &&
...
Check the top-level render call using <` +
				...
				__name2(warnForMissingKey, "warnForMissingKey");
				function renderChildrenArray(request, task, children, childIndex) {
					var { keyPath: prevKeyPath, componentStack: previousComponentStack } =
						task;
					var previousDebugTask = task.debugTask;
					pushServerComponentStack(task, task.node._debugInfo);
					if (
...
` +
				...
				var ROOT_HTML_MODE = 0,
					...
					HTML_TABLE_ROW_MODE = 8,
					HTML_COLGROUP_MODE = 9,
					textSeparator = stringToPrecomputedChunk("<!-- -->"),
					styleNameCache = /* @__PURE__ */ new Map(),
					...
					formStateMarkerIsMatching = stringToPrecomputedChunk("<!--F!-->"),
...
"$~";Promise.all(b).then($RC.bind(null,n,w),$RX.bind(null,n,"CSS failed to load"))};$RR("`),
				...
				var classComponentUpdater = {
					...
					HooksDispatcher = {
						...
						useEffect: noop,
						useDebugValue: noop,
						useDeferredValue: /* @__PURE__ */ __name2((value, initialValue) => {
							resolveCurrentlyRenderingComponent();
							return initialValue !== void 0 ? initialValue : value;
						}, "useDeferredValue"),
						useTransition: /* @__PURE__ */ __name2(() => {
				...
				exports.prerender = (children, options) =>
					new Promise((resolve, reject) => {
						var onHeaders = options ? options.onHeaders : void 0,
							onHeadersImpl;
						onHeaders &&
							(onHeadersImpl = /* @__PURE__ */ __name2((headersDescriptor) => {
							...
							request = createPrerenderRequest(
								...
								() => {
									var stream = new ReadableStream(
										{
											type: "bytes",
											pull: /* @__PURE__ */ __name2((controller) => {
												startFlowing(request, controller);
											}, "pull"),
											cancel: /* @__PURE__ */ __name2((reason) => {
												request.destination = null;
		...
		react_dom_server_legacy_browser_development = __toESM(
			require_react_dom_server_legacy_browser_development(),
			1,
		);
		react_dom_server_browser_development = __toESM(
			require_react_dom_server_browser_development(),
			1,
		);
		if (false) {
		} else {
...
function createMiddleware(providerInit) {
	return async (context2) => {
		context2.data = {
			...context2.data,
			...(await providerInit(context2)),
		};
		return await context2.next();
	};
}
__name(createMiddleware, "createMiddleware");
function Wrapper({ Children, ctx, propsData, pathname }) {
	ctx.data.loader = {
		get(manager) {
			const prop = propsData.find(
				(prop2) => prop2.name === manager.name && prop2.pathname === pathname,
			);
			if (!prop) {
				throw new Error(
...
function createStoreProvider(params) {
	const _delete = /* @__PURE__ */ __name2(async (pathname) => {
		await params.delete(pathname, params.ctx);
	}, "_delete");
	const _getStoreData = /* @__PURE__ */ __name2(async (pathname) => {
	...
	const _getStorePropsData = /* @__PURE__ */ __name2(async (pathname) => {
		const storeString = await params.get(`props::${pathname}`, params.ctx);
		if (storeString === null) return null;
		const values = fromStore(storeString);
		return values;
	}, "_getStorePropsData");
	const _setStorePropsData = /* @__PURE__ */ __name2(
		async (pathname, value) => {
			await params.set(`props::${pathname}`, toStore(value), params.ctx);
		},
		"_setStorePropsData",
	);
	const _set = /* @__PURE__ */ __name2(
		async ({ pathname, module, parser, ttl, ctx }) => {
			const page = module.default;
			const LoadersReturnValues = await Promise.all(
				Object.entries(module)
					.filter(([, exp]) => exp instanceof LoaderManager)
					.map(([_name, loader]) =>
						loader.props
							.callback(ctx)
			...
			const expiresAt = Date.now() + (ttl ?? 60 * 60 * 24) * 1e3;
			...
			const { renderToString } = await Promise.resolve().then(
				() => (init_chunk_331bw8en(), chunk_331bw8en_exports),
			);
			...
			const dataToStore = {
				pathname,
				data: await rewriter.transform(new Response(pageHTML)).text(),
				expiresAt,
			};
...
function SubLayout({ children }) {
	return /* @__PURE__ */ jsx_dev_runtime32.jsxDEV(
		"div",
		{
			children: [
				/* @__PURE__ */ jsx_dev_runtime32.jsxDEV(
					"h1",
					{
						children: "Sub Layout",
					},
...
function Shell({ children }) {
	return /* @__PURE__ */ jsx_dev_runtime42.jsxDEV(
		"html",
		{
			lang: "en",
			children: [
				/* @__PURE__ */ jsx_dev_runtime42.jsxDEV(
					"head",
					{
						children: [
							/* @__PURE__ */ jsx_dev_runtime42.jsxDEV(
...
function PageWrapper({ children, pathname }) {
	return /* @__PURE__ */ jsx_dev_runtime52.jsxDEV(
		Shell,
		{
			children: [
				/* @__PURE__ */ jsx_dev_runtime52.jsxDEV(
					"script",
					{
...
var cloudflareKV_default;
var exports_layout;
var jsx_dev_runtime22;
var exports_layout2;
var jsx_dev_runtime32;
var customEntrypoints;
var custom_entrypoints_default;
var NextJsStyleLayoutSetup;
var jsx_dev_runtime42;
var jsx_dev_runtime52;
var onRequest4;
var init_middleware = __esm({
	"_middleware.js"() {
		...
		__name2(toStore, "toStore");
		__name2(fromStore, "fromStore");
		__name2(createStoreProvider, "createStoreProvider");
		cloudflareKV_default = /* @__PURE__ */ __name2(
			(kv) =>
				createStoreProvider({
					get: /* @__PURE__ */ __name2(async (id, ctx) => {
						const value = await ctx.kv.get(id);
						return value;
					}, "get"),
					set: /* @__PURE__ */ __name2(async (id, value, ctx) => {
						await ctx.kv.put(id, value);
					}, "set"),
					delete: /* @__PURE__ */ __name2(async (id, ctx) => {
		...
		__export2(exports_layout, {
			default: /* @__PURE__ */ __name2(() => MainLayout, "default"),
		});
		jsx_dev_runtime22 = __toESM(require_jsx_dev_runtime(), 1);
		__name2(MainLayout, "MainLayout");
		exports_layout2 = {};
		__export2(exports_layout2, {
			default: /* @__PURE__ */ __name2(() => SubLayout, "default"),
		});
		jsx_dev_runtime32 = __toESM(require_jsx_dev_runtime(), 1);
		__name2(SubLayout, "SubLayout");
		customEntrypoints = {
		...
		__name2(Shell, "Shell");
		jsx_dev_runtime52 = __toESM(require_jsx_dev_runtime(), 1);
		__name2(PageWrapper, "PageWrapper");
		onRequest4 = middleware_default((ctx) => ({
...
var routes;
var init_functionsRoutes_0_38181779459426457 = __esm({
	"../.wrangler/tmp/pages-zYRqTZ/functionsRoutes-0.38181779459426457.mjs"() {
		init_id();
		init_subroute();
		init_sync();
		init_middleware();
...
function parse(str, options) {
	...
	var i = 0;
	var path = "";
	var tryConsume = /* @__PURE__ */ __name2((type) => {
		if (i < tokens.length && tokens[i].type === type) return tokens[i++].value;
	}, "tryConsume");
	var mustConsume = /* @__PURE__ */ __name2((type) => {
	...
	var consumeText = /* @__PURE__ */ __name2(() => {
		var result2 = "";
		var value2;
	...
	var isSafe = /* @__PURE__ */ __name2((value2) => {
	...
	var safePattern = /* @__PURE__ */ __name2((prefix2) => {
...
function regexpToFunction(re, keys, options) {
	...
	return (pathname) => {
		...
		var _loop_1 = /* @__PURE__ */ __name2((i2) => {
...
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
var drainBody = /* @__PURE__ */ __name2(
...
var jsonError = /* @__PURE__ */ __name2(
	async (request, env2, _ctx, middlewareCtx) => {
		try {
			return await middlewareCtx.next(request, env2);
		} catch (e) {
...
var __Facade_ScheduledController__ = class ___Facade_ScheduledController__ {
	static {
		__name(___Facade_ScheduledController__, "___Facade_ScheduledController__");
	}
	...
	static {
		__name2(___Facade_ScheduledController__, "__Facade_ScheduledController__");
	}
	#noRetry;
	noRetry() {
...
function wrapExportedHandler(worker) {
	...
	const fetchDispatcher = /* @__PURE__ */ __name2((request, env2, ctx) => {
	...
	return {
		...
		fetch(request, env2, ctx) {
			const dispatcher = /* @__PURE__ */ __name2((type, init) => {
...
var drainBody2 = /* @__PURE__ */ __name(
	async (request, env2, _ctx, middlewareCtx) => {
		try {
			return await middlewareCtx.next(request, env2);
		} finally {
...
var jsonError2 = /* @__PURE__ */ __name(
	async (request, env2, _ctx, middlewareCtx) => {
		try {
			return await middlewareCtx.next(request, env2);
		} catch (e) {
...
// .wrangler/tmp/bundle-WpIYMB/middleware-insertion-facade.js
...
function __facade_invokeChain__2(
	request,
	env2,
	ctx,
	dispatch,
...
// .wrangler/tmp/bundle-WpIYMB/middleware-loader.entry.ts
var __Facade_ScheduledController__2 = class ___Facade_ScheduledController__2 {
	...
	static {
		__name(___Facade_ScheduledController__2, "__Facade_ScheduledController__");
	}
	#noRetry;
	noRetry() {
...
//# sourceMappingURL=functionsWorker-0.5138269368564846.js.map
