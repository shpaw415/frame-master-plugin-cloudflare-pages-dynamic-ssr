...
function TestComponent() {
  const [data, setData] = import_react.useState(0);
  return /* @__PURE__ */ jsx_dev_runtime.jsxDEV("button", {
    onClick: () => setData((c) => c + 1),
    type: "button",
    children: [
      "Test button ",
      data
...
async function Subroute() {
  ...
  return /* @__PURE__ */ jsx_dev_runtime2.jsxDEV("div", {
    children: [
      ...
      /* @__PURE__ */ jsx_dev_runtime2.jsxDEV(TestComponent, {}, undefined, false, undefined, this)
    ]
  }, undefined, true, undefined, this);
}

// src/actions/subroute/index.tsx
"no-action";
var onRequest = async (ctx) => {
  ...
  return new Response(type === "javascript" ? ModuleParser(storedData.module, exports_subroute) : HTMLParser(storedData.html), {
    status: 200,
    headers: header
  });
};
